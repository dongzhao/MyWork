...
namespace MyWork.Web
{
    public class RestServiceClient : IRestServiceClient
    {
        ...
        public UserProfileDto SaveUserProfile(UserProfileDto dto)
        {
            var content = StringContext(JsonConvert.SerializeObject(dto), Encode.UTF8, "application/json");
            ...
            return GetUserProfile(dto.UserName);
        }
